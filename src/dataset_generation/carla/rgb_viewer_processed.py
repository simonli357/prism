...
CAMERAS = [
    {
        "name": "gt_ne",
        "image_topic": "/carla/ego_vehicle/gt_"+semantic_str+"camera_ne/image_rgb",
        "info_topic":  "/carla/ego_vehicle/gt_"+semantic_str+"camera_ne/camera_info",
    },
    {
        "name": "gt_nw",
        "image_topic": "/carla/ego_vehicle/gt_"+semantic_str+"camera_nw/image_rgb",
        "info_topic":  "/carla/ego_vehicle/gt_"+semantic_str+"camera_nw/camera_info",
    },
    {
        "name": "gt_se",
        "image_topic": "/carla/ego_vehicle/gt_"+semantic_str+"camera_se/image_rgb",
        "info_topic":  "/carla/ego_vehicle/gt_"+semantic_str+"camera_se/camera_info",
    },
    {
        "name": "gt_sw",
        "image_topic": "/carla/ego_vehicle/gt_"+semantic_str+"camera_sw/image_rgb",
    ...
    {
        "name": "front",
        "image_topic": "/carla/ego_vehicle/"+semantic_str+"camera_front/image_rgb",
        "info_topic":  "/carla/ego_vehicle/"+semantic_str+"camera_front/camera_info",
    },
    {
        "name": "left",
        "image_topic": "/carla/ego_vehicle/"+semantic_str+"camera_left/image_rgb",
        "info_topic":  "/carla/ego_vehicle/"+semantic_str+"camera_left/camera_info",
    },
    {
        "name": "rear",
        "image_topic": "/carla/ego_vehicle/"+semantic_str+"camera_rear/image_rgb",
        "info_topic":  "/carla/ego_vehicle/"+semantic_str+"camera_rear/camera_info",
    },
    {
        "name": "right",
        "image_topic": "/carla/ego_vehicle/"+semantic_str+"camera_right/image_rgb",
    ...
    {"name": "front_rgb", "image_topic": "/carla/ego_vehicle/camera_front/image_rgb",
