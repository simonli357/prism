...
class ElevationMap:
    ...
    def __init__(self, param: Parameter):
        ...
        """
        print("ElevationMap Constructor!!!!")
        self.kernel_time = time.time()
    ...
    def update_map_with_kernel(self, points_all, channels, R, t, position_noise, orientation_noise):
        ...
        """
        # print("kernel time: ", time.time() - self.kernel_time)
        # self.kernel_time = time.time()
        self.new_map *= 0.0
    ...
    def input_image(
        ...
        Returns:
            None:
        """
        # print("input image time: ", time.time() - self.image_time)
        # self.image_time = time.time()
        ...
        # temp_elevation_map = self.plugin_manager.layers.copy()
        # temp_elevation_map[0] = self.plugin_manager.layers[1]
        with self.map_lock:
    ...
    def get_map_with_name_ref(self, name, data):
        ...
        with self.map_lock:
            if name == "elevation":
                ...
                # print("Plugin layer requested: ", name)
                ...
                # print("SHAPE: ", self.elevation_map[0].shape)
